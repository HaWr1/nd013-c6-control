    ...
    if (s != "") {
      ...
      error_steer =
          ...
          yaw; // the task of the steer controller is
               ...
               // the path can be calculated with the current and next target
               // point in the x-y plane and yaw is the current heading of the
               // vehicle according to project instructions.
      ...
      error_throttle =
          v_points.back() -
          velocity; // the task of the throttle controller is
                    // to reach the vehicle target speed.
                    // Therefore the control error is calculated as
                    // the difference between the current vehicle
                    // velocity and the target velocity.
                    // last point of v_points is current target velocity and
                    // velocity is the current speed of the vehicle according to
